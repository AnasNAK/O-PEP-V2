    ...
    <div class="h-screen md:flex">
        <div
            ...
            <div>
                ...
                <a href="SingUp.php">
                    <button type="submit"
                        class="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2">Sing Up</button>
                </a>
            </div>
        ...
        <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
            <form class="bg-white" method="POST" action="../controller/S-In.php">
                ...
                <button type="submit" name="submit"
                    class="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">connect
                    </button>
